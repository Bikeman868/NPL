...
export const binaryOperatorGraphBuilder = new GraphBuilder('binary-operator');
...
export const expressionTermGraphBuilder = new GraphBuilder('expression-term');
export const functionCallGraphBuilder = new GraphBuilder('function-call');
export const indexExpressionGraphBuilder = new GraphBuilder('index-expression');
export const literalListGraphBuilder = new GraphBuilder('literal-list');
export const literalMapGraphBuilder = new GraphBuilder('literal-map');
...
export const subExpressionGraphBuilder = new GraphBuilder('sub-expression');
export const testGraphBuilder = new GraphBuilder('test');
export const unaryOperatorGraphBuilder = new GraphBuilder('unary-operator');
